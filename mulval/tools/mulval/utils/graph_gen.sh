...
echo "First execution of XSB" >> log_for_me.log
...
echo "Second execution of XSB" >> log_for_me.log
...
if [ -f trace_output.P ]; then
    ...
    echo "Execution of attack_graph" >> log_for_me.log
    ...
    mv ARCS.CSV ARCS_TEMP.CSV
    cat ARCS_TEMP.CSV | sort | uniq > ARCS.CSV
    rm ARCS_TEMP.CSV
